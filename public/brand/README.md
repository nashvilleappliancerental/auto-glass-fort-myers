...
| `social-avatar.png` | 1024×1024 profile picture (mark + accent glow), safe under a circle crop — Facebook/Yelp/Google/Instagram/LinkedIn avatars. Generated by `scripts/make-social.mjs`. |
| `fb-cover.jpg` | 1640×624 Facebook cover — photo + centered branded lockup. Generated by `scripts/make-social.mjs`. |
